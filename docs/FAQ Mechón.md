...
La Oficina CaDCC aka Ofisalita es la sala ubicada justo al lado de la Salita (Oficina 332). En principio es la oficina del Centro de Alumnos, pero está abierta a todo público y es una opción un poco más relajada que la Salita. Puedes estar y/o trabajar en ella sin problemas. Tiene mesas, algunas pantallas, una pizarra y un rincón con un puff para dormir semi-escondido (aka *Hiho's Corner*). En este lugar también están guardados los juegos de mesa y es hogar del Kioskito CaDCC.
...
No es necesario cambiar de código para dar los ramos y estudiar en el DCC. Sin embargo, con el código tendrás acceso a las dependencias del Depto, a tu cuenta personal para el uso de computadores y servidores; y 150 impresiones mensuales acumulables con un **máximo de 400**. Lamentablemente perderás tus impresiones del CEC :c. Cabe notar que al momento de titularte sí debes tener el código de la carrera.
